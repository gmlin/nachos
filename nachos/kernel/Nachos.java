...
public class Nachos implements Runnable {
     ...
     * various subsystems, depending on configuration options. Start test
     * programs, if appropriate. Once this method is finished, the first thread
     * terminates. Any activities that are to continue must have their own
     * threads by that point.
     */
     ...
     *
     * @param args
     *            is the array of command line arguments, which is used to
     *            initialize a global Options object, which is used by the
